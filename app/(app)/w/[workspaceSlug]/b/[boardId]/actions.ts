...
// NOTE: `inviteToBoard` lives in `./settings/members/actions.ts` — that version
// inserts the invitation row AND fires the Resend email + in-app notification.
// There used to be a stub here that only wrote the row; it has been removed so
