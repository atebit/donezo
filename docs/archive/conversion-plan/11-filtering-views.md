...
- **Search expand animation** — input width `58 → 140px` over `--motion-medium` on focus. Chrome border on focus `0.5px --color-primary`, bg white. Cursor flips `pointer → text` on focus. See [§1.4](component-system.md#14-boardfilter-toolbar).
