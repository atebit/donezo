...
Drawer is better for "context next to the row" UX — this is the monday-style pattern. We keep the route so links work.
...
- **Update editor card** — outline `1px solid --color-primary`, radius 4px, height 145px. Save button bg `--color-primary`, white text, height 32px, radius 4px. See [§4.1](component-system.md#41-commentlist--commentitem) (the editor chrome is part of the CommentList contract).
